...
public class GameRVR {
    ...
    public int[] start(RandomPlayer p1, RandomPlayer computer, Stack<Card> deck, String starter) {
    ...
    public int[] play(RandomPlayer p1, RandomPlayer computer, Stack<Card> deck, String starter) {
    ...
    public double[] simulate_games(double num, int[] pistiSayisip1, int[] pistiSayisip2) {
        ...
        System.out.println("Random1 winning percentage: " + (random_wins * 100) / num + "%");
        System.out.println("Random2 winning percentage: " + (AI_wins * 100) / num + "%");
